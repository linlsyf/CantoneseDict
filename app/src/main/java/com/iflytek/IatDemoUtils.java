...
public class IatDemoUtils {
	private static String TAG = IatDemoUtils.class.getSimpleName();
	// 语音听写对象
		...
		public void onResult(RecognizerResult results, boolean isLast) {
			...
			if (resultType.equals("json")) {
				...
				if (mCallBack!=null){
					...
					String callMsg=buffer.toString().trim();
					callMsg=callMsg.replace("。","");
					callMsg=callMsg.replace(".","");
					mCallBack.call(callMsg);
				}
...
//				mResultText.setSelection(mResultText.length());
	...
	private void printResult(RecognizerResult results) {
		...
		if (mCallBack!=null){
			...
			String callMsg=resultBuffer.toString().trim();
			callMsg=callMsg.replace("。","");
			callMsg=callMsg.replace(".","");
			mCallBack.call(callMsg);
		}
...
//		mResultText.setSelection(mResultText.length());
	...
	public void setParam() {
		...
		mTranslateEnable = mSharedPreferences.getBoolean( activity.getString(R.string.pref_key_translate), false );
		if( mTranslateEnable ){
