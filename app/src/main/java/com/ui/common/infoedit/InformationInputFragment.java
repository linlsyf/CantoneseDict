 ...
 * 输入信息界面
 */
public class InformationInputFragment extends BaseFragment implements IinputView {
    ...
    InformationInputPresenter  inputPresenter;
            ...
            @Override
              ...
              public void initUIView() {
      		   ...
      		   TopBarBuilder.buildOnlyText(toolbar, getActivity(), NavigationBar.Location.RIGHT_FIRST, "确定", 0);
                     inputPresenter=new InformationInputPresenter(this);
