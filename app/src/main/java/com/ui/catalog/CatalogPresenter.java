...
//		  itemBean.setTitle(iSafeSettingView.getContext().getString(R.string.start_percent));
...
//		  itemBeaBasen.setTitle(iSafeSettingView.getContext().getString(R.string.learn_base_yp));
