 ...
 * DAO for table "DICT".
*/
public class DictDao extends AbstractDao<Dict, String> {
    ...
    */
    ...
    @Override
    protected final String updateKeyAfterInsert(Dict entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(Dict entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
